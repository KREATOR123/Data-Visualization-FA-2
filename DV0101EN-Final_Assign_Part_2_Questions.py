...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        umemp_veh= recession_data.groupby(['Vehicle_Type','unmemployment_rate'])['Automobile_Sales'].mean().reset_index()
...
# Plot 2 Total Monthly Automobile sales using line chart.
        Y_chart2 = dcc.Graph(yearly_data, x='Month', y='Automobile_Sales', title="Monthly Automobile Sales")
